...
public class FlightControllerTest {
	...
	void testAddFlight() throws Exception {
		...
		mockMvc.perform(post("/api/v1.0/flights/airline/inventory/addFlight").contentType("application/json")
	...
	void testSearchFlights() throws Exception {
		...
		mockMvc.perform(post("/api/v1.0/flights/search").contentType("application/json")
	...
	void testGetFlightDetails() throws Exception {
		...
		mockMvc.perform(get("/api/v1.0/flights/10")).andExpect(status().isOk())
